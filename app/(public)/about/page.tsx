    ...
    <>
      ...
      <div className="container py-12">
        ...
        <p className="mt-4 max-w-2xl text-lg text-ink-600">
          Surjora is a digital services provider focused on Chinese platforms. We help individuals
          and businesses around the world get verified accounts and digital services for WeChat, QQ,
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <section>
            ...
            <p className="mt-3 text-ink-600">
              ...
              receive your account and credentials electronically, with setup guidance and
              after-sale support.
            </p>
          </section>
          <section>
